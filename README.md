# Metaverse VR Starter Kit for Unity
...
<img width="1510" height="854" alt="Screenshot 2025-07-28 at 1 43 49 AM" src="https://github.com/user-attachments/assets/4362f517-2e42-40b9-8834-064137b331d2" />
...
3. Go to `Assets > Import Package > Custom Package...`  Add 'XR Interaction Toolkit'
   Select the downloaded `.unitypackage` and import all assets.

4. Open OculusBase Setup.

5. Press Play — the rig, hands, input, and interactions are ready.
